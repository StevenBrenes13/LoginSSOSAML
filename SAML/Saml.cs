...

{
	...
	{
		public Response(X509Certificate2 certificateBytes, string certificateStr, string responseString = null) : base(certificateStr, responseString) { }
